...
df = df %>%
  mutate(DATAHORA_INICIO = as.POSIXct(DATAHORA_INICIO),
         DATAHORA_FIM = as.POSIXct(DATAHORA_FIM),
         DEPARTURE_DATAHORA = as.POSIXct(DEPARTURE_DATAHORA),
         RETURN_DATAHORA = as.POSIXct(RETURN_DATAHORA),
...
temp %>%
   ...
   group_by(CNTRY, IEMBARCA, Power.of.main.engine, ARTE_CODFAO, Metier_6, RETURN_PORTO, DATAHORA_FIM, LANCE_NUM, effort, RECT_ESTAT_FIM_EFETIVO) %>%
...
temp_1 =
   ...
   mutate(CNTRY = 'PRT',
          ...
          Metier_6 = NA,
          effort = as.numeric((DATAHORA_FIM-DATAHORA_INICIO)/3600)) %>%
   group_by(CNTRY, IEMBARCA, Power.of.main.engine, ARTE_CODFAO, Metier_6, RETURN_PORTO, DATAHORA_FIM, LANCE_NUM, effort, RECT_ESTAT_FIM_EFETIVO, ESPECIE_CODFAO) %>%
